package de.tolstun.testcontainer.spring_example.integration_test

import de.tolstun.testcontainer.extension.impl.container.*
import de.tolstun.testcontainer.spring_example.integration_test.config.DbDatasetDirectory
import de.tolstun.testcontainer.spring_example.integration_test.config.DbMigrationDirectory
import de.tolstun.testcontainer.spring_example.integration_test.config.YamlTestDirectory
...
open class ExampleTest {
    ...
    companion object {
        ...
        val postgreSQLContainer: PostgreSQLContainer = PostgreSQLContainer(
            ...
            internalContainerName = "db--itest-testcontainer-extension",
            internalDomain = "db",
            databaseName = "basedb",
        ...
        val employeeContainer: JavaRestApiContainer = JavaRestApiContainer(
            jarFile = File("""./target/spring-example-impl-0.1.0.jar"""),
            internalContainerName = "employee--itest-testcontainer-extension",
